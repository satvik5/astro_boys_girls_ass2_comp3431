...
gnome-terminal --tab --title="QR Interpreter" -- bash -ic "cd ~/python_ws; ros2 run publisher3431 listener_ass2 use_sim_time:=true"
gnome-terminal --tab --title="QR transformer" -- bash -ic "cd ~/python_ws; ros2 run publisher3431 listener; $SHELL"
