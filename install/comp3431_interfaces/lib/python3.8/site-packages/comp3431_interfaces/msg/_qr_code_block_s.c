...
bool comp3431_interfaces__msg__qr_code_block__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("comp3431_interfaces.msg._qr_code_block.QRCodeBlock", full_classname_dest, 50) == 0);
  }
  comp3431_interfaces__msg__QRCodeBlock * ros_message = _ros_message;
  {  // text
...
{
  /* NOTE(esteve): Call constructor of QRCodeBlock */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("comp3431_interfaces.msg._qr_code_block");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QRCodeBlock");
