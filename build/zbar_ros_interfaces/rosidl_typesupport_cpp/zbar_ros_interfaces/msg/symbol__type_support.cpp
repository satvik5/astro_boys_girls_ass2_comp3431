...
static const _Symbol_type_support_symbol_names_t _Symbol_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zbar_ros_interfaces, msg, Symbol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zbar_ros_interfaces, msg, Symbol)),
  }
};
...
{
  return &::zbar_ros_interfaces::msg::rosidl_typesupport_cpp::Symbol_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zbar_ros_interfaces, msg, Symbol)() {
  return get_message_type_support_handle<zbar_ros_interfaces::msg::Symbol>();
}
