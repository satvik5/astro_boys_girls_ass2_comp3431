...
static const _QRCodeBlock_type_support_symbol_names_t _QRCodeBlock_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, comp3431_interfaces, msg, QRCodeBlock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, comp3431_interfaces, msg, QRCodeBlock)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, comp3431_interfaces, msg, QRCodeBlock)() {
  return &::comp3431_interfaces::msg::rosidl_typesupport_c::QRCodeBlock_message_type_support_handle;
}
