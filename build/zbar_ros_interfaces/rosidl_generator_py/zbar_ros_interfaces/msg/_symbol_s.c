...
bool zbar_ros_interfaces__msg__symbol__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zbar_ros_interfaces.msg._symbol.Symbol", full_classname_dest, 38) == 0);
  }
  zbar_ros_interfaces__msg__Symbol * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Symbol */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zbar_ros_interfaces.msg._symbol");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Symbol");
